...
if($num>0){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        $FirstName = $generic->getitemlabel('employee','EmployeeID',$row['EmployeeID'],'FirstName');
        $LastName = $generic->getitemlabel('employee','EmployeeID',$row['EmployeeID'],'LastName');
